...
import { TenantSelector, McpTenant, availableTenants } from '@/features/mcp/components/TenantSelector';
import { StructuredAIReport } from '@/features/analytics/components/StructuredAIReport';
