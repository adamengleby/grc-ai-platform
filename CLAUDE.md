...
- **Frontend**: `https://grc-frontend-simple.calmmeadow-5080198e.australiasoutheast.azurecontainerapps.io`
- **Backend**: `https://grc-backend-simple.calmmeadow-5080198e.australiasoutheast.azurecontainerapps.io`
...
## 🏗️ **AZURE CONTAINER APPS ARCHITECTURE**
...
# Health Check
curl https://grc-backend-simple.calmmeadow-5080198e.australiasoutheast.azurecontainerapps.io/api/v1/health
```

### **3. Frontend Deployment Commands**
```bash
...
# Health Check
curl https://grc-frontend-simple.calmmeadow-5080198e.australiasoutheast.azurecontainerapps.io/health
```
...
### **📋 MAINTAIN ROBUST DEPLOYMENT PROCESS**
