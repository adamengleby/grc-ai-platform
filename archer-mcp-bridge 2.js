...
/**
 * HTTP Bridge for Archer MCP PoC
 * Wraps the working PoC MCP server and provides HTTP endpoints
 * that preserve existing API contracts while using the superior PoC implementation
 */
